...
import logo from "../../../assets/images/madhurendra-logo.png";
...
const Navbar = ({ onLinkClick }) => {
  ...
  return (
    <nav
      className={`nav_bar navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar navbar-fixed-top py-3 ${
